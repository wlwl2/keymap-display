...
export default class KeymapDisplayView {
  constructor (serializedState) {
    ...
    const searchCommand = window.atom.keymaps.findKeyBindings({'command': 'keymap-display:search'})[0].keystrokes
    mainHeading.textContent = 'Keymap Display (' + toggleCommand + ' to close this panel, ' + groupsCommand + ' to switch groups, ' + searchCommand + ' to search)'
    ...
    searchInput.className = 'search-input native-key-bindings'
